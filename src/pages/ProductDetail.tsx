...
import { ArrowLeft, Star, Truck, Shield, RefreshCw, ShoppingBag, Heart } from "lucide-react";
...
const products = [
  ...
  },
  {
    ...
    price: 59,
    image: product2,
    description: "Experience ultimate softness with our Cloud Nine premium tee. Made from a luxurious cotton-modal blend that feels like a dream against your skin.",
    sizes: ["XS", "S", "M", "L", "XL"],
  ...
  },
  {
    ...
    price: 54,
    image: product3,
    description: "Street-ready style meets everyday comfort. The Urban Fog features an oversized silhouette with dropped shoulders for that effortlessly cool look.",
    sizes: ["S", "M", "L", "XL", "XXL"],
